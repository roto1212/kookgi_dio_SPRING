...
//		xml파일에서 설정한 bean 정보를 읽어오려면 아래의 방법을 사용한다.
		AbstractApplicationContext ctx = new GenericXmlApplicationContext("classpath:applicationCTX.xml");
		
//		java 파일에서 설정한 bean정보를 읽어오려면 아래의 방법을 사용한다.
//		new AnnotationConfigApplicationContext(bean을 설정한 클래스이름.class);
//		AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(ApplicationConfig.class);
		
		System.out.println("xml파일에서 설정한 bean을 읽어온다.");
		...
		System.out.println("=================================");
		System.out.println("java파일에서 설정한 bean을 읽어온다.");
