...
//		컨트롤러에서 Model인터페이스 객체에 저장해 넘겨준 HttpServletRequest  인터페이스 객체에서 insert.jsp에서 입력한 데이터를 읽어낸다.
...
//		Model 인터페이스 객체에서 저장되서 넘어온 HttpServletRequest 인터페이스 객체에서 insert.jsp에서 넘어온 데이터를 받는다.
